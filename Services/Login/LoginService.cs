...
public class LoginService : ILoginService {
    ...
    public async Task<UserSessionDTO> MarkSessionAsAuthenticated(string sessionId, string id_token)
    {
        ...
        {
            _logger.LogError(e, "Error updating User Session");
            throw;
        }
    }
    ...
    public async Task<UserSessionDTO> Logout(string sessionId) {
        try
        {
        ...
        {
            _logger.LogError(e, "Error logging out User Session");
            throw;
        }
    }
