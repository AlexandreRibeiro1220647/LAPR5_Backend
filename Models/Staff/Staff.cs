...
namespace TodoApi.Models.Staff
{
    public class Staff : Entity<LicenseNumber>
    {
        ...
        public Staff(FullName fullName, Specialization specialization, UserEmail email, Phone phone, AvailabilitySlots availabilitySlots)
        {
        ...
        public Staff(FullName fullName, Specialization specialization, UserEmail email, Phone phone)
        {
            this.FullName = fullName;
            this.Specialization = specialization;
            Id = new LicenseNumber(Guid.NewGuid().ToString());
